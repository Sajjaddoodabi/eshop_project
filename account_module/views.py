...
from account_module.form import RegisterForm, LoginForm, ForgotPasswordForm, ResetPasswordForm
...
class RegisterView(View):
    ...
    def post(self, request):
        ...
        if register_form.is_valid():
            ...
            if user:
                register_form.add_error('email', 'این ایمیل تکراری میباشد')
            else:
                new_user = User(
                    email=user_email,
