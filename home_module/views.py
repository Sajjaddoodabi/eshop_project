...
class HomeView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        categories = list(
            ProductCategory.objects.annotate(product_count=Count('product_categories')).filter(
                is_delete=False,
                is_active=True,
                product_categories__gt=0)[:6])
        ...
        context['most_bought_products'] = group_list(list(most_bought_products))
